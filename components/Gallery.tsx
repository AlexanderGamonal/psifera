...
const products = [
    {
        ...
        description: "Nuestra receta original, rica en hierro y fibra. Perfecta para empezar el día con energía y combatir la anemia.",
        imageSrc: "./images/galleta-sangrecita.png"
    },
    {
        name: "Clásica de Chocolate y Hierro",
        description: "El delicioso sabor del chocolate combinado con un extra de hierro. ¡El snack saludable favorito de los niños!",
        imageSrc: "./images/galleta-chocolate.png"
    },
    {
        name: "Quinua Power con Pasas",
        description: "Una poderosa mezcla de quinua, pasas y nutrientes esenciales. Ideal para deportistas y mentes activas.",
        imageSrc: "./images/galleta-quinua.png"
    },
    {
        name: "Galleta de Kiwicha y Naranja",
        description: "La kiwicha, un superalimento andino, con un toque cítrico de naranja. Llena de sabor y vitaminas.",
...
const ProductCard: React.FC<{ product: typeof products[0] }> = ({ product }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 flex flex-col">
            <img src={product.imageSrc} alt={`Galleta de ${product.name}`} className="w-full h-50 object-cover" />
            <div className="p-6 flex flex-col flex-grow">
                <h3 className="font-serif text-2xl text-brand-brown-dark mb-2">{product.name}</h3>
                <p className="text-brand-text leading-relaxed mb-4 flex-grow">{product.description}</p>
                <button 
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="mt-4 text-lg max-w-2xl mx-auto text-brand-text">
                        Cada galleta está hecha con amor e ingredientes de la más alta calidad para nutrirte en cada bocado.
                    </p>
